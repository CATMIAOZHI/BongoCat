...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(generate_handler![
            ...
            core::pair::pair_get_secret,
            core::pair::pair_set_server_password,
            core::pair::pair_has_server_password,
            core::pair::pair_get_server_password,
            core::pair::pair_delete_server_password,
